                ...
                <section id="about">
                    ...
                    <div class="about flex-column">
                        ...
                        <div class="row bg-opaque">
                            <div class="col-sm-6">
                                <h3>About the Edition</h3>
                                <br />
                                <p>If James Howell had to wager that one of his many works would go on to be of value to
                                    futurity, he would certainly not have gone with his <em>Therologia</em>. His magnum opus,
                                    the <em>Familiar Letters</em>, would have been a safer bet. Be that as it may,
                                    <em>Therologia</em> remains a small jewel of wicked whimsy. Formed in the fires of England's Civil
                                    War, it speaks with relevance and sure-footedness in response to the optimisms and pessimisms of its
                                    day. Read in hindsight, it is a text full of
                                    gimlet-eyed foresight in an era many have labelled the Anthropocene
                                    and
                                    others, more cynically, will call the Misanthropocene. Howell's tale of Pererius, the
                                    wandering philosophical Ulysses seeking to restore humans back to their proper shape and stature is
                                    full
                                    of mischief for anyone who wishes to see humanity as headed solely in one damned direction.
                                    <br /><br />Across
                                    Howell's dialogues, one never knows with whom to
                                    side, the humanist in search of humanity or the beasts taking refuge in the innocence of
                                    animality. Along the way, Howell offers readers a valuable omnium-gatherum of political and economic
                                    history,
                                    natural philosophy, theology, and medicine akin to better-known works like Robert Burton's
                                    <em>Anatomy of Melancholy</em> or Thomas Browne's <em>Pseudodoxia Epidemica</em>. He does so,
                                    however, with characteristic flair for languages, etymologies, puns, and neologisms that grew out of his
                                    extensive travels. In this tale of humans giving up on humanity,
                                    it
                                    is hard not to see Howell as responding to the world-weary with a babble of new tongues and a
                                    world
                                    of reinvented names. His is not so much a discourse of "hope for humanity" as a desire to refresh
                                    human discourse itself. In this edition, his "feigned words" have been decoded, his neologisms
                                    and
                                    neo-proverbs underlined, and his many puns and references made explicit. It is not merely to ease the
                                    path for
                                    readers, but to help them stop and appreciate Howell's recreational (or rather re-creational)
                                    linguistics. I hope you enjoy.</p>
                            </div>
                            <div class="vl"></div>
                            <div class="col-sm-6">
                                <h3>About the Editor</h3>
                                <br />
                                <p><bold>Arnaud Zimmern</bold> is a postdoctoral fellow at the Navari Family Center for Digital Scholarship at the
                                    University of Notre Dame, where he specializes in digital cultural preservation with a focus on
                                    early modern works of literature, medicine, mathematics, and religion.<br /><br />
                                    His work appears in <em>English Literary History,</em> <em>Memoria di Shakespeare</em>, <em>The
                                        John Donne Journal</em>, and <em>James Joyce Quarterly</em>. His book project is entitled
                                    <em>The Cure of All: Panaceas and Progress from Shakespeare to Milton</em>. It makes the case
                                    that
                                    17th century literary authors defined the terms, genres, and narratives many of us use to
                                    imagine,
                                    talk about, and criticize global medical progress today. Howell emerges in that book as a
                                    complex
                                    figure standing at a major crossroads, torn between trusting in modern pharmaceutics (like Sir
                                    Kenelm Digby's "powder of sympathy") and praising the merit of untampered, all-natural remedies
                                    like those touted by his beasts in <em>Therologia</em>. <br /><br />
                                    Few endeavours are as rewarding as making newly available, with a little bit of spit, polish, and
                                    shine, a long-neglected work that deserves better reception. Arnaud is fortunate and grateful to
                                    have had time at the Navari Family Center for Digital Scholarship to give
                                    Howell's<em>Therologia</em> a deserved chance at reappraisal and magnify its qualities after a
                                    long
                                    winter in the shadows.</p>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <footer class="bg-primary text-light pt-5 pb-2 px-5">
                        ...
                        <div class="row">
                            <div class="col-sm-4" id="contact-info">
                                ...
                                <br />
                                <a href="https://cds.nd.edu">Navari Family Center for Digital Scholarship</a>
                                    <br />
                                    <hr/>
                            ...
                            <div class="col-sm-4" id="acknowledgements">
                                ...
                                <p> Special thanks to:
                                    <br />
                                    <a href="https://directory.library.nd.edu/directory/employees/djohns27"> Dr. Dan Johnson,</a>
                                    <br />
                                    <a href="https://cssh.northeastern.edu/person/sarah-connell/">Dr. Sarah Connell,</a>
                                    <br />
                                    <a href="https://randalseanharrison.com/">&amp; Dr.
                                        Randal Sean Harrison</a> </p>
                                <hr/>
                                    <p>TEI-XML edition provided by:
                                        <br />
                                        <a href="https://ota.bodleian.ox.ac.uk/repository/xmlui/">the Oxford Text Archive</a></p>
                            </div>
                            
                            
                            <div class="col-sm-4" id="download-buttons">
                                <!-- GITHUB REPO LINK -->
                                <button type="button" class="btn btn-primary px-3" href="https://azimmern.github.io/therologia/"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-github"
                                    viewBox="0 0 16 16">
                                    <path
                                ...
                                <button type="button" class="btn btn-primary px-3" href="main.xml" download="therologia.xml"><svg xmlns="http://www.w3.org/2000/svg" width="50"
                                    height="50" fill="currentColor" class="bi bi-arrow-down-square-fill" viewBox="0 0 16 16">
                                    <path
